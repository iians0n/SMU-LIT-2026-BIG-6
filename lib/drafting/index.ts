...
export function assembleDraft(c:Case,contradictions:Contradiction[]|null):Draft {
 ...
 // Several contradictions can ask the same fallback question. Show it once;
 // duplicate warning strings also produce duplicate React keys in the pack UI.
 const warnings=[...new Set(active.map(x=>x.question))];
