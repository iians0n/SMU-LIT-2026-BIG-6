...
export interface IssueAssessment{id:string;title:string;checklistVersion:string;factIds:string[];supportingExcerptIds:string[];conflictingExcerptIds:string[];supportStatus:'supported'|'partial_or_disputed'|'missing'|'not_assessed';reason:string;nextQuestion:string;contraryExplanation:string;sourceCaseVersion:number}
