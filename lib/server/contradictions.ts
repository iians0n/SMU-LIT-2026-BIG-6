...
const ContradictionSchema=z.object({id:z.string(),description:z.string(),question:z.string(),interpretations:z.array(z.string()),sourceRefs:z.array(SourceRefSchema),resolved:z.boolean()});
