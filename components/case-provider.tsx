...
export function CaseProvider({children}:{children:React.ReactNode}){
 ...
 const selected=sources.find(s=>s.id===sourceId);const value=useMemo(()=>({record,workflow,sources,loading,error,reload,mutate,openSource:setSourceId,toast:setNotice}),[record,workflow,sources,loading,error,reload,mutate]);
